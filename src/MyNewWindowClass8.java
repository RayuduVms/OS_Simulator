...
public class MyNewWindowClass8 extends JPanel 
{
	...
	{
		MyNewWindowClass8 d =new MyNewWindowClass8();
		JFrame j = new JFrame();
	...
	class Launch
	{
		...
		class Phil extends Thread
		{
			...
			public void run()
			{
				...
				{
					mutex.Wait_for_turn();						     
					chopstick[id].Wait_for_turn();				     
					chopstick[(id+1)%(num)].Wait_for_turn();         
					Status="Eating";
					...
					int timequantum=(int)(Math.random()*quantum);			       
					try
					{
					...
					chopstick[id].pick_the_chopsticks();				       
					chopstick[(id+1)%(num)].pick_the_chopsticks();   		   
					Status="Thinking";
					...
					mutex.pick_the_chopsticks();					          
					timequantum=(int)(Math.random()*quantum);			       
					try
					{
						Thread.sleep(timequantum);
					}	
